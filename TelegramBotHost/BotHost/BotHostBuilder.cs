...
namespace TelegramBotHost.BotHost
{
    public class BotHostBuilder : IBotHostBuilder
    {
        ...
        public IBotHost Build()
        {
            ...
            if (!_options!.SuppressStatusMessages)
            {
                if (Environment.GetEnvironmentVariable("Hosting:Environment") != null)
                    Console.WriteLine(
                        "The environment variable 'Hosting:Environment' is obsolete and has been replaced with 'TelegramBotHost_ENVIRONMENT'");

                if (Environment.GetEnvironmentVariable("ASPNET_ENV") != null)
                    Console.WriteLine(
                        "The environment variable 'ASPNET_ENV' is obsolete and has been replaced with 'TelegramBotHost_ENVIRONMENT'");

                if (Environment.GetEnvironmentVariable("TelegramBotHost_SERVER.URLS") != null)
                    Console.WriteLine(
                        "The environment variable 'TelegramBotHost_SERVER.URLS' is obsolete and has been replaced with 'TelegramBotHost_URLS'");
            }
        ...
        private IServiceCollection BuildCommonServices(out AggregateException hostingStartupErrors)
        {
            ...
            var listener = new DiagnosticListener("TelegramBotHost");
