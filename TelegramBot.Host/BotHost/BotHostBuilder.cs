    ...
    public class BotHostBuilder : IBotHostBuilder
    {
        ...
        public BotHostBuilder()
        {
            ...
            _config = new ConfigurationBuilder()
                .AddEnvironmentVariables("TelegramBot.Host_")
                .Build();
        ...
        public IBotHost Build()
        {
            ...
            if (!_options!.SuppressStatusMessages)
            {
                if (Environment.GetEnvironmentVariable("Hosting:Environment") != null)
                    Console.WriteLine(
                        "The environment variable 'Hosting:Environment' is obsolete and has been replaced with 'TelegramBot.Host_ENVIRONMENT'");

                if (Environment.GetEnvironmentVariable("ASPNET_ENV") != null)
                    Console.WriteLine(
                        "The environment variable 'ASPNET_ENV' is obsolete and has been replaced with 'TelegramBot.Host_ENVIRONMENT'");

                if (Environment.GetEnvironmentVariable("TelegramBot.Host_SERVER.URLS") != null)
                    Console.WriteLine(
                        "The environment variable 'TelegramBot.Host_SERVER.URLS' is obsolete and has been replaced with 'TelegramBot.Host_URLS'");
            }
